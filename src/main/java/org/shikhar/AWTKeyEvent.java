...
public class AWTKeyEvent extends InputEvent {
	...
	public static String getKeyModifiersText(int keycode) {
		return "" + (char)keycode; // TODO right and left soft key, joystick
	}

	public static String getKeyText(int modifiers) {
		return "" + (char)modifiers; // TODO right and left soft key, joystick
	}
	...
	public AWTKeyEvent(int id, int mask) {
		super(id, mask);
	}
