...
public class ExpressionBuilder {
    ...
    public ExpressionBuilder(String expression) {
        ...
        this.userFunctions = new HashMap<String, _Function>(4);
     ...
     * @param functions the custom {@link net.objecthunter.exp4j.function._Function} implementations
     * @return the ExpressionBuilder instance
     */
    public ExpressionBuilder functions(_Function... functions) {
        for (_Function f : functions) {
    ...
    /**
     * Add multiple {@link net.objecthunter.exp4j.function._Function} implementations available for use in the expression
     * @param functions A {@link java.util.List} of custom {@link net.objecthunter.exp4j.function._Function} implementations
     * @return the ExpressionBuilder instance
     */
    public ExpressionBuilder functions(List<_Function> functions) {
        for (_Function f : functions) {
            this.userFunctions.put(f.getName(), f);
        }
        return this;
    ...
    public Expression build() {
        ...
        for (String _var : variableNames) {
            if (Functions.getBuiltinFunction(_var) != null || userFunctions.containsKey(_var)) {
