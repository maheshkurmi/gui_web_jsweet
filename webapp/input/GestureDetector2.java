...
public class GestureDetector2  {
	...
	public GestureDetector2 (float halfTapSquareSize, float tapCountInterval, float longPressDuration, float maxFlingDelay,
	 ...
	 * @param maxFlingDelay time in seconds the finger must have been dragged for a fling event to be fired, see
	 *           {@link GestureListener#fling(float, float, int)} */
	public GestureDetector2 (float halfTapRectangleWidth, float halfTapRectangleHeight, float tapCountInterval, float longPressDuration, float maxFlingDelay,
		GestureListener listener) {
	...
	/** Register an instance of this class with a {@link GestureDetector2} to receive gestures such as taps, long presses, flings,
	...
	public static interface GestureListener {
		 ...
		 * time of the {@link GestureDetector2}.
