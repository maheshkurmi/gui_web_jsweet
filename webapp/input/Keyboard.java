...
public class Keyboard implements KeyListener {
	/** The keys */
	public Map<Integer, InputKey> keys = new HashMap<Integer, InputKey>();

	/**Flag to check if keyboard has some unconsumed events*/
	...
	public void keyPressed(KeyEvent e) {
		...
		//if(org.shikhar.simphy.Simphy.DEBUG )Simphy.instance.toolTipText=("key df="+e.getKeyChar()+", code="+e.getKeyCode()+", pressed=");//+input.isPressed()+", handled="+handled);
	...
	public void keyReleased(KeyEvent e) {
		//if(org.shikhar.simphy.Simphy.DEBUG )Simphy.instance.toolTipText=("key df="+e.getKeyChar()+", code="+e.getKeyCode()+", released=");//+input.isPressed()+", handled="+handled);

		// do not listen auto repeat keys
		if (true) {//0 == (InputEvent.AUTOREPEAT_MASK & e.getModifiers())) {
			int keyCode = e.getKeyCode();
	...
	/**
	 * returns true if keyboard has some unconsumed events
	 * @return
	 */
